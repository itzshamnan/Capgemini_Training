...
public class Q5_Menu {
    public static void main(String[] args) throws IOException {
        boolean flag = true;
        int i=1;
        while (flag) {
            String filePath = "C:\\Users\\mshamnan\\Downloads\\price.txt",
                    totalfilePath = "C:\\Users\\mshamnan\\Downloads\\totalprice.txt";
    ...
    public static void main1(String[] args) throws IOException {
        try (FileWriter fw = new FileWriter("C:\\Users\\mshamnan\\Downloads\\totalprice.txt", true);
             BufferedWriter bw = new BufferedWriter(fw);
             PrintWriter out = new PrintWriter(bw)) {
            out.println(100);
        } catch (Exception e) {
